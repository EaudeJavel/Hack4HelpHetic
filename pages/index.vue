<template>
	<div v-if="Object.keys(texts).length" class="container-page container-index">
		...
		<blockVideo :hasEdition="true" :isButton="true" :edition="texts.BLOCKVIDEO_EDITION" :title="texts.BLOCKVIDEO_TITLE" :video="texts.BLOCKVIDEO_VIDEO_SOURCE" :items="texts.BLOCKVIDEO_ITEMS" />
